...
import com.almadevelop.comixreader.screen.viewer.page.PageViewer
...
suspend inline fun SubsamplingScaleImageView.animateScaleAndCenterSuspended(
    newScale: Float = scale,
    newCenter: PointF = center!!,
    crossinline f: SubsamplingScaleImageView.AnimationBuilder.() -> Unit = {}
