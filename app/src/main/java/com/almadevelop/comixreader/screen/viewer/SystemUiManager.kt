...
import com.almadevelop.comixreader.extension.insetsFlow
import com.almadevelop.comixreader.extension.systemUiVisibilityChange
    ...
    companion object {
        operator fun invoke(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                SystemUiManagerLegacy(window, lifecycle, initState)
            }
    }
}
