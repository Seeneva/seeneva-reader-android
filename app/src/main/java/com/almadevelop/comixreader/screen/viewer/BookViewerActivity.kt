...
import com.almadevelop.comixreader.binding.viewBindingCustom
import com.almadevelop.comixreader.databinding.ActivityBookViewerBinding
...
import com.almadevelop.comixreader.extension.waitLayout
...
import com.almadevelop.comixreader.logic.entity.configuration.applyToWindow
...
class BookViewerActivity :
    ...
    private val viewerStatesBinding by viewBindingCustom {
        LayoutViewerStatesBinding.bind(viewBinding.viewerStatesLayout)
    }
    ...
    private val pagesPreviewAdapter by lazy {
        BookViewerPreviewAdapter(
            get(),
            parentJob = lifecycle.coroutineScope.coroutineContext.job,
