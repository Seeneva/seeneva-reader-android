object Version {
    ...
    const val ANDROIDX_PAGING = "2.1.1"
    const val ANDROIDX_PALETTE = "1.0.0"
    const val ANDROIDX_TEST_CORE_KTX = "1.2.0"
    const val ANDROIDX_TEST_JUNIT_KTX = "1.1.1"
    const val ANCROIDX_WORK_RUNTIME = "2.3.1"
    const val ANDROIDX_ROOM = "2.2.3"
...
object Deps {
    ...
    const val ANCROIDX_WORK_RUNTIME = "androidx.work:work-runtime-ktx:${Version.ANCROIDX_WORK_RUNTIME}"
