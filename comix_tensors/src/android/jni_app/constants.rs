...
pub const COMIC_BOOK_PAGE_OBJECT_TYPE: &str =
    "com/almadevelop/comixreader/data/entity/ComicPageObject";

pub const FILE_HASH_TYPE: &str = "com/almadevelop/comixreader/common/entity/FileHashData";

pub const INTERPRETER_TYPE: &str = "com/almadevelop/comixreader/data/entity/ml/Interpreter";
pub const TESSERACT_TYPE: &str = "com/almadevelop/comixreader/data/entity/ml/Tesseract";
...
pub mod Results {
    pub const COMIC_PAGE_IMAGE_DATA_TYPE: &str =
        "com/almadevelop/comixreader/data/entity/ComicPageImageData";
