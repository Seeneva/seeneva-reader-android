...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_source_jni_Native_initInterpreterFromAsset(
    env: JNIEnv,
    _: JClass,
    asset_mgr: JObject,
    file_name: JString,
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_source_jni_Native_initTesseractFromAsset(
    env: JNIEnv,
    _: JClass,
    asset_mgr: JObject,
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_entity_ml_Interpreter_closeNative(
    env: JNIEnv,
    interpreter: JObject,
) {
    check_input_argument!(
...
/// Close ML Interpreter
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_entity_ml_Tesseract_closeNative(
    env: JNIEnv,
    tesseract: JObject,
) {
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_source_jni_Native_getPageImageData(
    env: JNIEnv,
    _: JClass,
    file_descriptor: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_source_jni_Native_decodePage(
    env: JNIEnv,
    _: JClass,
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_entity_ComicPageImageData_closeNative(
    env: JNIEnv,
    encoded_page: JObject,
) {
    check_input_argument!(
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_almadevelop_comixreader_data_source_jni_Native_recogniseText(
    env: JNIEnv,
    _: JClass,
    tesseract: JObject,
    bitmap: JObject,
