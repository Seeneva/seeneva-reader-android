...
enum class License(
    ...
    APACHE2(License.SPDX_APACHE2, R.string.license_apache2),

    @SerialName(SPDX_BSD2)
    BSD2(License.SPDX_BSD2, R.string.license_bsd2),

    @SerialName(SPDX_GPL2_CE)
    GPL2_CE(License.SPDX_GPL2_CE, R.string.license_gpl2_ce),

    @SerialName(SPDX_MIT)
    MIT(License.SPDX_MIT, R.string.license_mit),

    @SerialName(ID_PUBLIC_DOMAIN)
    PUBLIC_DOMAIN(License.ID_PUBLIC_DOMAIN, R.string.license_public_domain),

    @SerialName(ID_FREE)
    FREE(License.ID_FREE, R.string.license_free),

    @SerialName(SPDX_GPL3_OR_LATER)
    GPL3_OR_LATER(License.SPDX_GPL3_OR_LATER, R.string.license_gpl3_or_later),

    @SerialName(SPDX_ID_CC_BY_4)
    CC_BY_4(License.SPDX_ID_CC_BY_4, R.string.license_cc_by_4);
